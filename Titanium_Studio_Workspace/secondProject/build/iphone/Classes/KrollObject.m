...
//@interface secondProjectObject : NSObject
//@end

@interface secondProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[secondProjectObject class]])
		{
			for (NSString *key in [[(secondProjectObject*)o modules] allKeys])
			{
