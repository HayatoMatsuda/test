...
// in simulator we redefine to format for secondProject Developer console
...
{\
	NSString * exceptionName = [@"org.secondproject." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.secondproject";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIsecondProjectNativeItemNone = -1, 
	UIsecondProjectNativeItemSpinner = -2,
	UIsecondProjectNativeItemProgressBar = -3,
	
	UIsecondProjectNativeItemSlider = -4,
	UIsecondProjectNativeItemSwitch = -5,
	UIsecondProjectNativeItemMultiButton = -6,
	UIsecondProjectNativeItemSegmented = -7,
	
	UIsecondProjectNativeItemTextView = -8,
	UIsecondProjectNativeItemTextField = -9,
	UIsecondProjectNativeItemSearchBar = -10,
	
	UIsecondProjectNativeItemPicker = -11,
	UIsecondProjectNativeItemDatePicker = -12,
	
	UIsecondProjectNativeItemInfoLight = -13,
	UIsecondProjectNativeItemInfoDark = -14,
	
	UIsecondProjectNativeItemDisclosure = -15,
	
	UIsecondProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all secondProject instances of
