...
/**
 Base class for all secondProject views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the secondProject view hierarchy (such as wrapped iOS UIViews) was touched.
