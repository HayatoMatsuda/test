...
//Rare exceptions to indicate a bug in the _secondproject code (Eg, function that a subclass should have implemented)
...
/**
 The base class for secondProject proxies.
 */
