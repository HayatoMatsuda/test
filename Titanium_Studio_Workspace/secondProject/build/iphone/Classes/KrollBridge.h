...
@interface secondProjectObject : KrollCoverageObject {
#else
@interface secondProjectObject : KrollObject {
#endif
@private
...
extern NSString * secondProject$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	secondProjectObject *_secondproject;
    KrollObject* console;
	BOOL shutdown;
